...
for c in cat:
	...
	plt.bar(x, y, 0.8, bottom=yy, color=pt.lightcolor.next(),label=c )
	yy += y
...
plt.savefig('set_style_horizontalgridwithoutticks.pdf')
...
pt.set_style('horizontalgrid')

plt.savefig('set_style_horizontalgrid.pdf')
